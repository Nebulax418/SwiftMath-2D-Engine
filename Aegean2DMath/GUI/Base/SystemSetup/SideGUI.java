...
public class SideGUI extends JPanel implements ActionListener {
    ...
    private final JCheckBox OpenQuad = new JCheckBox("Quad Calculator");
    ...
    public void setCalulatorFrame(){
        ...
        CalculatorButton.setBackground(new Color(143, 54, 150));
    ...
    public void setFormulaPanel(){
        formulaPanel.setBackground(new Color(48, 87, 53));
    ...
    public void setOptionsRadioBtn(){
        ...
        TriangleRbtn.setForeground(new Color(255, 255, 255));
        ...
        CircleRbtn.setForeground(new Color(255, 255, 255));
    ...
    public void setOpenQuadCalculator() {
        ...
        OpenQuad.setBackground(new Color(0,0,0));
